...
export const TABELAS_BACKUP = [
  ...
  // Caixa (0151): a conferência de saldo e o registro das importações são o
  // que permite provar, depois, que o saldo do sistema era o do banco.
  "balance_checkpoints", "statement_imports", "transfers",

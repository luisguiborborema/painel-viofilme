...
export function DocumentsCard({ documents }: { documents: FinanceDocument[] }) {
  return (
    <Card className="p-5">
      ...
      <ul className="space-y-2">
        {documents.map((doc) => (
          ...
          >
            ...
            <button
              className="inline-flex items-center justify-center rounded-lg border border-line bg-subtle p-2 text-muted transition-colors hover:text-ink"
      ...
      <button className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-xl border border-line bg-subtle px-4 py-2.5 text-sm font-medium text-ink transition-colors hover:bg-subtle-strong">
